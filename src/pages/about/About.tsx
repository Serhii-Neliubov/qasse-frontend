...
// Hero
import petal1Img from "@assets/about/petal.svg";
...
import personImg from "@assets/about/person-flowers.svg";
...
// Glow Intelligently
import personGlowImg from "@assets/about/glow-intelligently/personImg.svg";
    ...
    return (
        <>
          ...
          <div className={styles.heroContainer}>
            ...
            <img src={petal1Img} alt='Image' className={styles.heroImg1}/>
          </div>
          ...
          <div className={styles.glowIntelligentlyContainer}>
            <div className={styles.glowIntelligentlyContent}>
              ...
              <img src={personGlowImg} alt='Image' className={styles.glowIntelligentlyImg1} />
